...
bubbleSort_iterative(on: &array2)
bubbleSort_iterative(on: &array3)
bubbleSort_iterative(on: &array4)
...
bubbleSort_recursion(on: &array)
bubbleSort_recursion(on: &array2)
bubbleSort_recursion(on: &array3)
bubbleSort_recursion(on: &array4)
